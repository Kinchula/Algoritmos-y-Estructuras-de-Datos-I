...
multpares xs = productoria' (mispares xs) id
 {-- como productoria' toma una lista y un predicado, tomo como uno de los
 argumentos a la lista con los elementos que sean pares, aplico productoria y
 llamo a la funcion id, la funcion identidad.
--}
...
--definición recursiva de la cuantificación generalizada
cuantGen :: (b -> b -> b) -> b -> [a] -> (a -> b) -> b --toma como arg su operador, el neutro, una función término t y una lista
cuantGen op z [] t = z
